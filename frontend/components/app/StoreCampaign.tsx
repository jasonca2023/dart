            ...
            >
              {products.map((p, i) => {
                ...
                return (
                  ...
                  <li key={i} className="tile-reveal" data-index={i}>
                    <button
                      type="button"
                      onClick={() => toggle(i)}
                      aria-pressed={on}
                    ...
                    >
                      ...
                      >
                        ...
                        <img
                          ...
                          loading="lazy"
                          className={
                            "absolute inset-0 size-full object-contain p-3 transition-transform duration-300 ease-out group-hover:scale-[1.05] " +
                            (on ? "scale-[1.02]" : "")
                          }
                        />
